    ...
    <div className={darkMode ? "dark" : ""} style={{height: "100vh"}}>
      ...
      <Navbar setDarkMode={setDarkMode} darkMode={darkMode} />
        ...
        <form className="w-[320px] h-[280px] p-4 flex flex-col dark:bg-main-bg bg-main-dark-bg items-center gap-8">
          ...
          <input className="border-b-1 text-white border-gray-500 w-full focus:outline-none bg-transparent p-2" type="text" placeholder="username"value={username} onChange={(e) => setUsername(e.target.value)}/>
          <input className="border-b-1 text-white border-gray-500 w-full focus:outline-none bg-transparent p-2"  type="password" placeholder="password"value={password} onChange={(e) => setPassword(e.target.value)}/>
